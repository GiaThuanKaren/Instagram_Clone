...
function SearchDrawer() {
  ...
  return (
    <>
      <div className=" max-h-screen animate-SlideIn  rounded-tr-xl rounded-br-xl  border-[1px] border-[#DBDBDB] absolute left-full  right-0 top-0 bottom-0 h-screen z-[2] w-[400px] bg-white pt-2 px-1 ">
...
function LeftSideBar() {
  ...
  const [DrawerActiveArr, setDrawerActiveArr] = useState<string>("/nofti");

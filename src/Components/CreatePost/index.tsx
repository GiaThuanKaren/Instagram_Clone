  ...
  return (
    <>
      <div className="fixed w-screen h-screen top-0 bottom-0 right-0 left-0 overflow-hidden bg-[#595959] z-[2] flex justify-center items-center">
        <div className="absolute right-0 top-0 p-4 text-white text-[1.5rem]">
          <ICON icon={IconSolid.faXmark} />
        </div>
        <div className="w-[700px] h-[70%] bg-white rounded-xl overflow-hidden">
          ...
          <div className="flex items-center justify-center h-full ">
            <div className="flex flex-col items-center">
              ...
              <button className="cursor-pointer text-white bg-[#0095F6] px-2 py-1 rounded-sm">
                Chọn từ máy tính
              </button>
            </div>
          </div>

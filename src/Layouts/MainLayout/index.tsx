    ...
    <>
      <div className=" bg-white flex items-center justify-between px-4 fixed z-[2] h-[60px] top-0 left-0 right-0 w-full md:hidden border-b-2  boder-[#DBDBDB]">
        ...
        <div className="flex items-center">
          ...
          <ICON className="ml-2 text-white" icon={IconSolid.faChevronDown} />
        </div>
        <div className="flex items-center">
          <div className="flex items-center  bg-[#EFEFEF] w-max px-4 rounded-md py-1 mr-2">
            <ICON className="text-[#EFEFEF]" icon={IconSolid.faSearch} />
            <input
              type="text"
              placeholder="Tìm kiếm"
              className="outline-none border-none bg-[#EFEFEF]"
            />
          </div>
          <ICON className="text-[1.2rem]" icon={IconRegular.faHeart} />
        </div>
      </div>
    </>
  );
                ...
                <Link key={index} href={`${item.link}`}>
                  ...
                  >
                    <div className="flex items-center p-3">
                      <div className="mr-2 text-[1.3rem] ">{item.icon}</div>

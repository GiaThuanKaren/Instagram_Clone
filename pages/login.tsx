                        ...
                        return (
                            <>
                                <div
                                    ...
                                    className={
                                        "rounded-sm w-full mt-2 flex items-center px-5 py-2 justify-center hover:cursor-pointer " +
                                        `${item.bgColor}`
                                    }
                                >
                                    {item.Icon}
